        ...
        <>
            <footer class="center size-60">
                <div className="social-medias">
                    <FiFacebook className='social-icon' size={30} color='#fff' />
                    <FiInstagram className='social-icon' size={30} color='#fff' />
                    <FiTwitter className='social-icon' size={30} color='#fff' />
                    <FiYoutube className='social-icon' size={30} color='#fff' />
                </div>
